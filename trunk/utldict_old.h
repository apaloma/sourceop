...
public:
	...
	// at each increment.
	CUtlDictOld( bool caseInsensitive = true, int growSize = 0, int initSize = 0 );
	~CUtlDictOld( );
...
protected:
	...
	mutable CUtlSymbolOldTable	m_SymbolTable;
};
...
//-----------------------------------------------------------------------------
template <class T, class I>
bool CUtlDictOld<T, I>::DictLessFunc( const DictElement_t &src1, const DictElement_t &src2 )
{
...
//-----------------------------------------------------------------------------
template <class T, class I>
CUtlDictOld<T, I>::CUtlDictOld( bool caseInsensitive, int growSize, int initSize ) : m_Elements( growSize, initSize, DictLessFunc ), 
	m_SymbolTable( growSize, initSize, caseInsensitive )
{
}

template <class T, class I> 
CUtlDictOld<T, I>::~CUtlDictOld()
{
}
...
//-----------------------------------------------------------------------------
template <class T, class I>
inline T& CUtlDictOld<T, I>::Element( I i )        
{ 
	return m_Elements[i].m_Data; 
}

template <class T, class I>
inline const T& CUtlDictOld<T, I>::Element( I i ) const  
{ 
	return m_Elements[i].m_Data; 
}
...
//-----------------------------------------------------------------------------
template <class T, class I>
inline char *CUtlDictOld<T, I>::GetElementName( I i )
{
	return (char *)( m_SymbolTable.String( m_Elements[ i ].m_Name ) );
}

template <class T, class I>
inline char const *CUtlDictOld<T, I>::GetElementName( I i ) const
{
	return m_SymbolTable.String( m_Elements[ i ].m_Name );
}

template <class T, class I>
inline T& CUtlDictOld<T, I>::operator[]( I i )        
{ 
	return Element(i); 
}

template <class T, class I>
inline const T & CUtlDictOld<T, I>::operator[]( I i ) const  
{ 
	return Element(i); 
}

template <class T, class I>
inline void CUtlDictOld<T, I>::SetElementName( I i, char const *pName )
{
...
//-----------------------------------------------------------------------------
template <class T, class I>
inline	unsigned int CUtlDictOld<T, I>::Count() const          
{ 
...
//-----------------------------------------------------------------------------
template <class T, class I>
inline	bool CUtlDictOld<T, I>::IsValidIndex( I i ) const 
{
...
//-----------------------------------------------------------------------------
template <class T, class I>
inline I CUtlDictOld<T, I>::InvalidIndex()         
{ 
...
//-----------------------------------------------------------------------------
template <class T, class I>
void CUtlDictOld<T, I>::RemoveAt(I elem) 
{
...
//-----------------------------------------------------------------------------
template <class T, class I> void CUtlDictOld<T, I>::Remove( const char *search )
{
	I node = Find( search );
...
//-----------------------------------------------------------------------------
template <class T, class I>
void CUtlDictOld<T, I>::RemoveAll()
{
	m_Elements.RemoveAll();
}

template <class T, class I>
void CUtlDictOld<T, I>::Purge()
{
	m_Elements.RemoveAll();
}
...
template <class T, class I>
void CUtlDictOld<T, I>::PurgeAndDeleteElements()
{
...
//-----------------------------------------------------------------------------
template <class T, class I> 
I CUtlDictOld<T, I>::Insert( const char *pName, const T &element )
{
	DictElement_t elem;
...
template <class T, class I> 
I CUtlDictOld<T, I>::Insert( const char *pName )
{
	DictElement_t elem;
	elem.m_Name = m_SymbolTable.AddString( pName );
	I idx = m_Elements.Insert( elem );
...
//-----------------------------------------------------------------------------
template <class T, class I> 
I CUtlDictOld<T, I>::Find( const char *pName ) const
{
	DictElement_t elem;
	elem.m_Name = m_SymbolTable.AddString( pName );
...
//-----------------------------------------------------------------------------
template <class T, class I> 
I CUtlDictOld<T, I>::First() const
{
	return m_Elements.FirstInorder();
}

template <class T, class I> 
I CUtlDictOld<T, I>::Next( I i ) const
{
